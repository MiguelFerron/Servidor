...
if (!isset($_SESSION['cesta'])) {
    $_SESSION['cesta'] = array(); // o [] si estás usando PHP 5.4 o posterior
}
...
<?php
    ...
    if (isset($_POST['vaciar'])) {
        // Verificamos que la cesta esté definida antes de intentar vaciarla
        if (isset($_SESSION['cesta'])) {
            unset($_SESSION['cesta']);
            $_SESSION['cesta'] = array(); // Volvemos a inicializar la cesta vacía
        }
    }
